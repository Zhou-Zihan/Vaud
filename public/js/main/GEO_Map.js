...
svg.on('mousedown', function () {
	...
	d3.select('body')
		...
		.on('mousemove', function () {
			d3.select('#sceneviewfold').style(
				'height',
				d3.event.y -
					(mapsize_mousey - parseFloat(sceneviewfold_height)) +
					'px'
			)
			d3.select('#mapsize').style(
				'top',
				d3.select('#sceneviewfold').style('height')
			)
			d3.select('#leftmenu').style(
				'top',
				d3.select('#sceneviewfold').style('height')
			)
			d3.select('#queryrecommand').style(
				'top',
				d3.select('#sceneviewfold').style('height')
			)
