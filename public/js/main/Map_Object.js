        ...
        if(map_object[i].show) {
            if (map_object[i].highlight||map_object[i].ismove) {
                switch(map_object[i].type){
                    case"car":{
                        highlightpaint_cartraj(map_object[i]);break;}
                    case"blog":{
                        highlightpaint_blogtraj(map_object[i]);break;}
                    case"carlist":{
                        highlightpaint_carlisttraj(map_object[i]);break;}
                    case"poi":{
                        highlightpaint_poitraj(map_object[i]);break;}
                    case"people":{
                        highlightpaint_peopletraj(map_object[i]);break;}
                    case"peoplelist":{
                        highlightpaint_peoplelisttraj(map_object[i]);break;}
                    case"estate":{
                        highlightpaint_estatetraj(map_object[i]);break;}
                    case"social_network":{
                        highlightpaint_social_networktraj(map_object[i]);break;}
                    case"social_networklist":{
                        highlightpaint_social_networklisttraj(map_object[i]);break;}
                    case"weather":{
                        highlightpaint_weathertraj(map_object[i]);break;}  
                }
            }
        }
    }
...
function add_mapobject(type,id,node){
    ...
    if(type=="car") {
        var thisobject = { type: "car", id: id.ID, data: id.data, show: true, highlight: 0, ismove: 0, node: node};
    ...
    if(type=="carlist") {
        var data=id;
        var thisobject = {type: "carlist", id:"node"+node,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="peoplelist") {
        var data=id;
        var thisobject = {type: "peoplelist", id:"node"+node,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="blog") {
        var data=id;
        var thisobject = {type: "blog", id:data.name,data: data, show: true, highlight: 1, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="bloglist") {
        var data=id;
        var thisobject = {type: "bloglist", id:"node"+node,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="social_network") {
        var data=id;
        var thisobject = {type: "social_network",
            id:data.otherid,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="social_networklist") {
        var data=id;
        var thisobject = {type: "social_networklist",
            id:data[0].thisid,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
        add_map_objectlist_object(thisobject);
    }
    ...
    if(type=="poi") {
        var data=id;
        var thisobject = {type: "poi",id:data.area, data: data, show: true, highlight: 1, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="poilist") {
        var data=id;
        var thisobject = {type: "poilist", id:"node"+node,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="estate") {
        var data=id;
        var thisobject = {type: "estate",id:data.detailname, data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
    ...
    if(type=="estatelist") {
        var data=id;
        var thisobject = {type: "estatelist", id:"node"+node,data: data, show: true, highlight: 0, node: node, ismove: 0};
        map_object.push(thisobject);
...
function highlightpaint_street_viewtraj(lon,lat){
    var street=d3.select("#sceneviewfold").append("div").attr("id","streetview")
        ...
        .style("top",0)
        .style("left",0)
    street.append("object")
        .style("height","100%")
        .style("width","100%")
        .attr("data","http://api.map.baidu.com/pano/?x=" +
        (lon*1+0.011)+"&y=" +
        (lat*1+0.002)+"&lc=0&ak=898c90ef23b14cc3b755d7a2cb64d150")
