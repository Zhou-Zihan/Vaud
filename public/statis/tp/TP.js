d3.select("#Timepicker")
	.on("mousedown",function(){
                              ...
                              week = 0
                              timechosen = 0
	         bigcircle = d3.select("body").append("div")//外框
			...
			.style("border","1px solid #d3d3d3")
     			...
     			.on("mouseover",function(){
     				...
     				//Yeardiv.style("background-color","#dcdcdc")
     			})
     			.on("mouseout",function(){
     				...
     				//Yeardiv.style("background-color","#e8e8e8")
     			})
     			.on("click",function(){
                                                            year = 1
                                                            month = 0
			...
			.style("border","1px solid #d3d3d3")
     			...
     			.on("mouseover",function(){
     				...
     				//Monthdiv.style("background-color","steelblue")
     			})
     			.on("mouseout",function(){ 
                                                            if(month == 0){
                                                                 Monthdiv.style("border","1px solid #d3d3d3")
     				...
     				//Monthdiv.style("background-color","#e8e8e8")
     			})
     			.on("click",function(){
                                                            year = 0
                                                            month = 1
			...
			.style("border","1px solid #d3d3d3")
     			...
     			.on("mouseover",function(){
     				...
     				//Donediv.style("background-color","steelblue")
     			})
     			.on("mouseout",function(){
                                                            Donediv.style("border","1px solid #d3d3d3")
                                                            Donediv.style("color","#8e8e8e")
     				//Donediv.style("background-color","#e8e8e8")
     			})
     			.on("click",function(){
                                                            done_exe();
                                             })
...
function year_board(){
               ...
               rightboard = innercircledown.append("div")
                              ...
                              .style("border","1px solid #b7b7b7")
                              .style("border-radius","5px")
                              .style("background-image","url(right.png)")
                              .on("mouseover",function(){
...
function done_exe(){
               d3.select("#Timepicker").attr("value","")
               TPtext = d3.select("#Timepicker").attr("value")
                    ...
                    for(i=0;i<yearchosen.length;i++){
                         for(j=0;j<monthchosen.length;j++){
                              for(k=0;k<datechosen.length;k++){
                                   ...
                                   if(monthchosen[j]<9){
                                        if(datechosen[k]>9){
                                             d3.select("#Timepicker").attr("value",TPtext+yearchosen[i]+"-0"+(monthchosen[j]+1)+"-"+(datechosen[k]+1)+" "+beginhour+":"+beginmin+"~"+endhour+":"+endmin+"; ")
                                        }
                                        else{
                                             d3.select("#Timepicker").attr("value",TPtext+yearchosen[i]+"-0"+(monthchosen[j]+1)+"-0"+(datechosen[k]+1)+" "+beginhour+":"+beginmin+"~"+endhour+":"+endmin+"; ")
                                        }
                                   }
                                   else{
                                        if (datechosen[k]<9) {
                                             d3.select("#Timepicker").attr("value",TPtext+yearchosen[i]+"-"+(monthchosen[j]+1)+"-0"+(datechosen[k]+1)+" "+beginhour+":"+beginmin+"~"+endhour+":"+endmin+"; ")
                                        }
                                        else{
                                             d3.select("#Timepicker").attr("value",TPtext+yearchosen[i]+"-"+(monthchosen[j]+1)+"-"+(datechosen[k]+1)+" "+beginhour+":"+beginmin+"~"+endhour+":"+endmin+"; ")
                                        }
                                   }
                              }
                         }
                    ...
                    for(i=0;i<yearchosen.length;i++){
                         for(j=0;j<monthchosen.length;j++){
                              for(k=0;k<weekchosen.length;k++){
                                   switch(weekchosen[k]){
                                        case 0:
                                             week = d3.time.sundays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 1:
                                             week = d3.time.mondays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 2:
                                             week = d3.time.tuesdays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 3:
                                             week = d3.time.wednesdays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 4:
                                             week = d3.time.thursdays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 5:
                                             week = d3.time.fridays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                        case 6:
                                             week = d3.time.saturdays(new Date(yearchosen[i],monthchosen[j],1), new Date(yearchosen[i],monthchosen[j]+1,0));
                                             break;
                                   }
                                   ...
                                   for(n=0;n<week.length;n++){
                                        ...
                                        d3.select("#Timepicker").attr("value",TPtext+week[n]+" "+beginhour+":"+beginmin+"~"+endhour+":"+endmin+"; ")
                                   }
                              }
                         }
                    }
